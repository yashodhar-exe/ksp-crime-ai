...
class User(Base):
    ...
    employee_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("employee.employee_id"), nullable=True, unique=True)
    ...
    employee: Mapped["Employee | None"] = relationship(back_populates="user_account")  # noqa: F821
