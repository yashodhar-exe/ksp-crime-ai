...
class ComplainantDetails(Base):
    ...
    occupation_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("occupation_master.occupation_id"), nullable=True)
    religion_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("religion_master.religion_id"), nullable=True)
    caste_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("caste_master.caste_master_id"), nullable=True)
